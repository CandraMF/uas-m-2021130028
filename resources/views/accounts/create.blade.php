        ...
        <div class="d-flex justify-content-between">
            <div class="d-flex">
                ...
                <div class="d-flex justify-center align-self-center">
                    <h4 class="h-auto m-0">Tambah Akun</h4>
                </div>
            </div>
            <div>
    ...
    <div class="card rounded-4 border-0 shadow-lg mt-3 mb-5 p-5">
        <form action="{{ route('accounts.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input name="id" type="text" class="form-control" id="id" placeholder="Masukkan 16 Digit Angka" @error('id') is-invalid @enderror value="{{ old('id') }}">
                @error('id')
            ...
            <div class="mb-3">
                ...
                <input name="nama" type="text" class="form-control" id="nama" placeholder="Masukkan Nama" @error('nama') is-invalid @enderror value="{{ old('nama') }}">
                @error('nama')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <input type="radio" class="btn-check" value="Personal" name="jenis" id="personal" autocomplete="off" {{ @old('jenis') == 'Personal'? 'checked' : '' }}>
                <label class="btn btn-outline-primary" value="Personal" for="personal">Personal</label>

                <input type="radio" class="btn-check" value="Bisnis" name="jenis" id="bisnis" autocomplete="off" {{ @old('jenis') == 'Bisnis'? 'checked' : '' }}>
